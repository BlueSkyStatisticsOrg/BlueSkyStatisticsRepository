...
namespace BSky.Controls
{
    ...
    public partial class BSkyAddFixedEffects : Button, IBSkyControl
    {
       ...
       Grid g = new Grid();
        ...
        public BSkyAddFixedEffects()
        {
            InitializeComponent();

            base.Content = "test";
            imgDest.BeginInit();
            imgDest.UriSource = new Uri(@"pack://application:,,,/BSky.Controls;component/Resources/add.png");
            imgDest.EndInit();
        ...
        [Description("Clicking on this control creates a fixed effect")]
        ...
        public string Type
        {
            get
            {
                return "Specify a fixed effect (used to create a model)";
            }
        }
