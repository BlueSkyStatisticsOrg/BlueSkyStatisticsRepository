...
namespace BSky.Controls
{
   ...
   // [DefaultProperty("Name")]
    ...
    public partial class DragDropListForSummarize : ListBox
    {


        public DragDropListForSummarize()
        {
            InitializeComponent();
...
//        public filter f;
       ...
       // Aaron 12/25 removed this. End use does not have to see this variable
        ...
        [Description("The default value of 'String|Numeric|Date|Logial|Ordinal|Nominal|Scale' indicates this variable list control allows variables of all types.Click the property and then click the ellipses button to restrict this control to one or more variable types.")]
       // [Category("Variable Settings")]
      ...
      //the problem was the drag and drop was initiated
        ...
        base.OnMouseMove(e);
           ...
           BSkyCanvas.sourceDrag = (DragDropListForSummarize)this;
      ...
      //This function checks whether the original source of the drag and drop was the scroll bar
        ...
        public string getFunctionFromComboBox()
        {
            string s="";
            Grid g = UIHelper.FindVisualParent<Grid>(this);
