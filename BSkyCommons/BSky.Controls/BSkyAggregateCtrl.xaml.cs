...
namespace BSky.Controls
{
    ...
    public partial class BSkyAggregateCtrl : Grid, IBSkyControl, IBSkyInputControl, IBSkyAffectsExecute, IBSkyEnabledControl
    {
        [TypeConverter(typeof(PropertySorter))]
        public BSkyAggregateCtrl()
        {
            InitializeComponent();
      ...
      //      TargetAggregate singleItemVar = new TargetAggregate();
        ...
        public string Type
        {
            get
            {
                return "Aggregate Control";
            }
            
        }


        //public DragDropListForSummarize getListBox()
        //{
        //    foreach (object child in this.Children)
        //    {
        //        if (child is TargetAggregate)
        //        {
        //             DragDropListForSummarize ctrl = child as TargetAggregate;

        //            //ctrl.ItemsSource = new ListCollectionView(new ObservableCollection<object>());
        //            }
        //        }
        //    }
               ...
               // return oneItemList.Filter;
                foreach (object child in this.Children)
                {
                    if (child is TargetAggregate)
                    {
                        ...
                        // targetListName = value;
                        //DragList child123;
                        TargetAggregate child1 = child as TargetAggregate;
     ...
     //   public event EventHandler<BSkyBoolEventArgs> CanExecuteChanged;
        ...
        // Aaron 09/16/2013
        //A simple way to access the TargetAggregate oject
       // public TargetAggregate oneItemList;
