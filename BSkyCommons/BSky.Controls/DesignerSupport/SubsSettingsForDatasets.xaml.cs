...
{
    /// <summary>
    /// Interaction logic for ManageDatasetSubs.xaml
    /// </summary>
    public partial class SubsSettingsForDatasets : Window
    {
        public SubsSettingsForDatasets(string prefixtxt, string SepCharacter)
        {
            InitializeComponent();
