...
namespace BSky.Controls.DesignerSupport
{
    ...
    /// </summary>
    public partial class MainDialogForPreviewWindow : Window
    {

        
        //IUIController UIController;
        public MainDialogForPreviewWindow()
        {
            InitializeComponent();
        ...
        public FrameworkElement Template
        {
            ...
            set
            {
                ...
                if (value.Width != double.NaN)
                {
                    ...
                    this.Width = value.Width + 30 + 15;//14May2015 last integer added by Anil ( for expander button)
                }
